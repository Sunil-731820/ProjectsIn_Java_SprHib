...
%>
		<tr style="background-color: red;">
			...
			<td><a href=ResolveComplaint.jsp?eComplaintId=<%=complaint.getComplaintId() %> > Update</a> </td>
		    <td><a href=DeleteComplaint.jsp?ComplaintId=<%=complaint.getComplaintId() %> > Delete</a> </td>
...
%>
		...
		<td><%=complaint.getSeverity() %></td>
		<td><%=complaint.getStatus() %></td>
		<td><a href=ResolveComplaint.jsp?eComplaintId=<%=complaint.getComplaintId() %> > resolve</a> </td>
		    <td><a href=DeleteComplaint.jsp?ComplaintId=<%=complaint.getComplaintId() %> > Delete</a> </td>
		</tr>
		<%
